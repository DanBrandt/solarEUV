...
def neuvacEUV(f107, f107a, bandLim=False, tableFile=None):
    """
    ...
    :param tableFile: str
        Corresponds to the .txt file holding the NEUVAC coefficients most recently-generated by prepareIrradiance.py. If
