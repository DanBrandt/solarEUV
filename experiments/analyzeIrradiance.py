...
if __name__=="__main__":
    ...
    # FIRST (TOP) ROW:
    # 425 A (index 12)
    ax[0, 0].scatter(sortedP, correspondingFism2Irr[sortIndsP, 12], label='FISM2', alpha=0.6)
    ax[0, 0].scatter(sortedP, euvacIrr[sortIndsP, 12], label='EUVAC', color='tab:green', alpha=0.6)
    ax[0, 0].scatter(sortedP, heuvacIrr[sortIndsP, 12], label='HEUVAC', color='tab:red', alpha=0.6)
    ax[0, 0].legend(loc='best')
    ax[0, 0].set_ylabel('Irradiance (W/m$^2$)')
    ax[0, 0].set_title('425 $\mathrm{\AA}$')
    # 725 A (index 24)
    ax[0, 1].scatter(sortedP, correspondingFism2Irr[sortIndsP, 24], label='FISM2', alpha=0.6)
    ...
    ax[0, 2].scatter(sortedP, heuvacIrr[sortIndsP, 31], label='HEUVAC', color='tab:red', alpha=0.6)
    ax[0, 2].legend(loc='best')
    ax[0, 2].set_title('975 $\mathrm{\AA}$')
    # SECOND (BOTTOM) ROW:
    solomonWavs = 0.5 * (solomonTable['short'] + solomonTable['long'])
    # 430 A (index 9)
    ax[1, 0].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 9], label='FISM2', alpha=0.6)
    ax[1, 0].scatter(sortedP, solomonIrrEUVAC[sortIndsP, 9], label='EUVAC', color='tab:green', alpha=0.6)
    ax[1, 0].scatter(sortedP, solomonIrrHFG[sortIndsP, 9], label='HFG', color='purple', alpha=0.6)
    ax[1, 0].legend(loc='best')
    ax[1, 0].set_xlabel('P (sfu)')
    ax[1, 0].set_ylabel('Irradiance (W/m$^2$)')
    ax[1, 0].set_title('430 $\mathrm{\AA}$')
    # 724 A (11)
    ax[1, 1].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 11], label='FISM2', alpha=0.6)
    ax[1, 1].scatter(sortedP, solomonIrrEUVAC[sortIndsP, 11], label='EUVAC', color='tab:green', alpha=0.6)
    ax[1, 1].scatter(sortedP, solomonIrrHFG[sortIndsP, 11], label='HFG', color='purple', alpha=0.6)
    ax[1, 1].legend(loc='best')
    ax[1, 1].set_xlabel('P (sfu)')
    ax[1, 1].set_title('724 $\mathrm{\AA}$')
    # 981 A (19)
    ax[1, 2].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 19], label='FISM2', alpha=0.6)
    ax[1, 2].scatter(sortedP, solomonIrrEUVAC[sortIndsP, 19], label='EUVAC', color='tab:green', alpha=0.6)
    ax[1, 2].scatter(sortedP, solomonIrrHFG[sortIndsP, 19], label='HFG', color='purple', alpha=0.6)
    ax[1, 2].legend(loc='best')
    ax[1, 2].set_xlabel('P (sfu)')
    ax[1, 2].set_title('981 $\mathrm{\AA}$')
    # Save the figure:
    fig.tight_layout()
    fig.suptitle('Solar Irradiance vs. P', fontsize=16, fontweight='bold')
    ...
    # 425 A (index 12)
    ax[0, 0].scatter(sortedP, correspondingFism2Irr[sortIndsP, 12], label='FISM2', alpha=0.6)
    ax[0, 0].scatter(sortedP, ensemble_average_NeuvacIrr[sortIndsP, 12], label='EUVAC', color='tab:orange', alpha=0.6)
    ax[0, 0].legend(loc='best')
    ax[0, 0].set_ylabel('Irradiance (W/m$^2$)')
    ax[0, 0].set_title('425 $\mathrm{\AA}$')
    # 725 A (index 24)
    ax[0, 1].scatter(sortedP, correspondingFism2Irr[sortIndsP, 24], label='FISM2', alpha=0.6)
    ax[0, 1].scatter(sortedP, ensemble_average_NeuvacIrr[sortIndsP, 24], label='EUVAC', color='tab:orange', alpha=0.6)
    ax[0, 1].legend(loc='best')
    ax[0, 1].set_title('725 $\mathrm{\AA}$')
    # 975 (index 31)
    ax[0, 2].scatter(sortedP, correspondingFism2Irr[sortIndsP, 31], label='FISM2', alpha=0.6)
    ax[0, 2].scatter(sortedP, ensemble_average_NeuvacIrr[sortIndsP, 31], label='EUVAC', color='tab:orange', alpha=0.6)
    ax[0, 2].legend(loc='best')
    ax[0, 2].set_title('975 $\mathrm{\AA}$')
    # SECOND (BOTTOM) ROW:
    # 430 A (index 9)
    ax[1, 0].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 9], label='FISM2', alpha=0.6)
    ax[1, 0].scatter(sortedP, ensemble_average_NeuvacIrrSolomon[sortIndsP, 9], label='NEUVAC', color='tab:orange', alpha=0.6)
    ax[1, 0].legend(loc='best')
    ax[1, 0].set_xlabel('P (sfu)')
    ax[1, 0].set_ylabel('Irradiance (W/m$^2$)')
    ax[1, 0].set_title('430 $\mathrm{\AA}$')
    # 724 A (11)
    ax[1, 1].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 11], label='FISM2', alpha=0.6)
    ax[1, 1].scatter(sortedP, ensemble_average_NeuvacIrrSolomon[sortIndsP, 11], label='NEUVAC', color='tab:orange', alpha=0.6)
    ax[1, 1].legend(loc='best')
    ax[1, 1].set_xlabel('P (sfu)')
    ax[1, 1].set_title('724 $\mathrm{\AA}$')
    # 981 A (19)
    ax[1, 2].scatter(sortedP, correspondingIrrFISM2StanBands[sortIndsP, 19], label='FISM2', alpha=0.6)
    ax[1, 2].scatter(sortedP, ensemble_average_NeuvacIrrSolomon[sortIndsP, 19], label='NEUVAC', color='tab:orange', alpha=0.6)
    ax[1, 2].legend(loc='best')
    ax[1, 2].set_xlabel('P (sfu)')
    ax[1, 2].set_title('981 $\mathrm{\AA}$')
    # Save the figure:
    ...
    fig, axs = plt.subplots(nrows=1, ncols=3)
    axs[0].scatter(F107[sortF107], NEUVAC_resids_425[sortF107], color='orange', label='NEUVAC (n='+str(iterations)+')', alpha=0.6)
    axs[0].scatter(F107[sortF107], EUVAC_resids_425[sortF107], color='green', label='EUVAC', alpha=0.6)
    axs[0].scatter(F107[sortF107], HEUVAC_resids_425[sortF107], color='red', label='HEUVAC', alpha=0.6)
    axs[0].set_xlabel('F10.7 (sfu)')
    axs[0].set_ylabel('Percent Deviation from FISM2 (%)')
    axs[0].set_title('425 $\mathrm{\AA}$')
    axs[0].legend(loc='best')
    axs[1].scatter(F107[sortF107], NEUVAC_resids_725[sortF107], color='orange', label='NEUVAC (n='+str(iterations)+')', alpha=0.6)
    axs[1].scatter(F107[sortF107], EUVAC_resids_725[sortF107], color='green', label='EUVAC', alpha=0.6)
    axs[1].scatter(F107[sortF107], HEUVAC_resids_725[sortF107], color='red', label='HEUVAC', alpha=0.6)
    axs[1].set_xlabel('F107 (sfu)')
    axs[1].set_title('725 $\mathrm{\AA}$')
    axs[1].legend(loc='best')
    axs[2].scatter(F107[sortF107], NEUVAC_resids_975[sortF107], color='orange', label='NEUVAC (n='+str(iterations)+')', alpha=0.6)
    axs[2].scatter(F107[sortF107], EUVAC_resids_975[sortF107], color='green', label='EUVAC', alpha=0.6)
    axs[2].scatter(F107[sortF107], HEUVAC_resids_975[sortF107], color='red', label='HEUVAC', alpha=0.6)
    axs[2].set_xlabel('F107 (sfu)')
    axs[2].set_title('975 $\mathrm{\AA}$')
    axs[2].legend(loc='best')
    ...
    axs[0, 0].plot(lowSolarTimes, ensemble_average_NeuvacIrrSolomon[lowSolarTimeInds, 9], label='NEUVAC (n='+str(iterations)+')', lw=3)
    axs[0, 0].plot(lowSolarTimes, solomonIrrEUVAC[lowSolarTimeInds, 9], label='EUVAC', lw=3)
    ...
    axs[0, 2].plot(lowSolarTimes, ensemble_average_NeuvacIrrSolomon[lowSolarTimeInds, 19], label='NEUVAC (n='+str(iterations)+')', lw=3)
    axs[0, 2].plot(lowSolarTimes, solomonIrrEUVAC[lowSolarTimeInds, 19], label='EUVAC', lw=3)
    ...
    axs[1, 0].plot(highSolarTimes, ensemble_average_NeuvacIrrSolomon[highSolarTimeInds, 9], label='NEUVAC (n='+str(iterations)+')', lw=3)
    axs[1, 0].plot(highSolarTimes, solomonIrrEUVAC[highSolarTimeInds, 9], label='EUVAC', lw=3)
    ...
    axs[1, 1].plot(highSolarTimes, ensemble_average_NeuvacIrrSolomon[highSolarTimeInds, 11], label='NEUVAC (n='+str(iterations)+')', lw=3)
    axs[1, 1].plot(highSolarTimes, solomonIrrEUVAC[highSolarTimeInds, 11], label='EUVAC', lw=3)
    ...
    axs[1, 2].plot(highSolarTimes, ensemble_average_NeuvacIrrSolomon[highSolarTimeInds, 19], label='NEUVAC (n='+str(iterations)+')', lw=3)
    axs[1, 2].plot(highSolarTimes, solomonIrrEUVAC[highSolarTimeInds, 19], label='EUVAC', lw=3)
    ...
    axs[0].scatter(F107[sortF107], EUVAC_resids_430_Solomon[sortF107], color='green', label='EUVAC', alpha=0.6)
    ...
    axs[0].legend(loc='best')
    axs[1].scatter(F107[sortF107], NEUVAC_resids_725_Solomon[sortF107], color='orange', label='NEUVAC (n='+str(iterations)+')', alpha=0.6)
    axs[1].scatter(F107[sortF107], EUVAC_resids_725_Solomon[sortF107], color='green', label='EUVAC', alpha=0.6)
    axs[1].scatter(F107[sortF107], HFG_resids_725_Solomon[sortF107], color='purple', label='HFG', alpha=0.6)
    axs[1].set_xlabel('F107 (sfu)')
    axs[1].set_title('725 $\mathrm{\AA}$')
    axs[1].legend(loc='best')
    axs[2].scatter(F107[sortF107], NEUVAC_resids_981_Solomon[sortF107], color='orange', label='NEUVAC (n='+str(iterations)+')', alpha=0.6)
    axs[2].scatter(F107[sortF107], EUVAC_resids_981_Solomon[sortF107], color='green', label='EUVAC', alpha=0.6)
    axs[2].scatter(F107[sortF107], HFG_resids_981_Solomon[sortF107], color='purple', label='HFG', alpha=0.6)
    axs[2].set_xlabel('F107 (sfu)')
    axs[2].set_title('981 $\mathrm{\AA}$')
    axs[2].legend(loc='best')
